...
class ClassDatePage extends StatefulWidget {
  const ClassDatePage({super.key});

  @override
  State<ClassDatePage> createState() => _ClassDatePageState();
}
class _ClassDatePageState extends State<ClassDatePage> {
  ...
  List get _filteredClasses {
    final query = _searchControler.toLowerCase().trim();
            ...
            Row(
              children: [
                _InfoItem(
                  ...
                  label: '${item.studentsCount} siswa',
                ),
